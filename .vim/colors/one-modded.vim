" Name:    one-modded vim colorscheme
" Author:  Apis
" License: MIT
...
"    let s:vertsplit    = '181a1f'
  ...
  "call <sid>X('CursorLine',   '',              s:syntax_bg,  '')
  call <sid>X('CursorLine',   '',              s:vertsplit,  '')
  call <sid>X('Directory',    s:hue_2,         '',               '')
  call <sid>X('ErrorMsg',     '',              s:hue_5,          '')
  call <sid>X('VertSplit',    s:vertsplit,     s:vertsplit,               'none')
  call <sid>X('Folded',       s:syntax_bg,     s:syntax_fold_bg, '')
  call <sid>X('FoldColumn',   '',              s:mono_3,         '')
  call <sid>X('IncSearch',    s:syntax_bg,     s:hue_6_2,        '')
  call <sid>X('LineNr',       s:syntax_gutter, s:syntax_gut_bg,  '')
  call <sid>X('CursorLineNr', s:syntax_gutter,     s:syntax_bg,      'none')
...
"  call <sid>X('Normal',       s:syntax_fg,     s:syntax_bg,      '')
  call <sid>X('SignColumn',   '',              s:vertsplit,         '')
...
"hi Normal	guifg=NONE guibg=#202020 gui=NONE
