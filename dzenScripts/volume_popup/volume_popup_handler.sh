...
echo -en "^bg(#404040)^ca(1, amixer sset Master 10%- )^i($PAT/icons/minus.xbm)^ca()^p(10;3)^bg(#303030)"
echo -en $res
echo "^p(10;-3)^bg(#404040)^ca(1, amixer sset Master 10%+ )^fg($IFG)^i($PAT/icons/plus.xbm)^ca()"
